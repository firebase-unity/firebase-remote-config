...
- for version 7.0.1
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#7.0.1",
...
- for version 7.0.2
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#7.0.2",
...
- for version 7.1.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#7.1.0",
...
- for version 7.2.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#7.2.0",
...
- for version 8.1.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#8.1.0",
...
- for version 8.2.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#8.2.0",
...
- for version 8.3.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#8.3.0",
...
- for version 8.4.0
```csharp
"com.google.firebase.remote-config": "https://github.com/Gamee-Studio/firebase-remote-config.git?path=Assets/_Root#8.4.0",
